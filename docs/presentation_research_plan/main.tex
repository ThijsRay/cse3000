...
\frametitle{Context}
\begin{itemize}
    \item Gender bias is present in word embeddings~\footcite{bolukbasi_2016_quantifying_stereotypes}
    \item Typically measured the help of analogies
    \begin{itemize}
        \item \textit{man} is to \textit{king} as \textit{woman} is to \textit{queen}
        \item \textit{man} is to \textit{doctor} as \textit{woman} is to \textit{nurse}~\footcite{bolukbasi_2016_quantifying_stereotypes}
    \end{itemize}
    \item However, analogies might not be the right tool to measure bias~\footcite{2019arXiv190509866N}
    \begin{itemize}
